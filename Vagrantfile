...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "vagrant-scaffold.dev"
  ...
  config.vm.synced_folder "./www", "/var/www/vagrant-scaffold", :mount_options => ["dmode=777", "fmode=666"]
  ...
  config.vm.provision "ansible" do |a|
    ...
    a.vault_password_file = "~/.ansible-vault/vagrant-scaffold"
  end
